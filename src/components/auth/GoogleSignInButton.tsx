...
export function GoogleSignInButton() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Ya no necesitamos manejar el error aquí, signInWithOAuth redirige
    // y si hay un error, se manejará en la página de login a la que se redirige.
    // setLoading(false) no se alcanzará si la redirección es exitosa.
  };
  ...
  return (
    ...
    >
      <svg className="w-5 h-5 mr-2 -ml-1" viewBox="0 0 488 512">
        <path
          fill="currentColor"
