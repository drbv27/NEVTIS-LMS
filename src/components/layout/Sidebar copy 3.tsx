...
const adminNavItems = [
  ...
  },
  {
    ...
    href: "/admin/courses",
    icon: ShieldCheck,
    // CORRECCIÓN: Añadimos 'partner' aquí
...
export default function Sidebar() {
  ...
  const filteredAdminNavItems = adminNavItems.filter((item) => {
    if (isProfileLoading || !profile) return false;
    // Un partner NO debe ver los links de admin, a menos que ya estén en partnerNavItems o sea Course Management
  ...
  // Eliminamos duplicados por si acaso, aunque la lógica actual lo previene
